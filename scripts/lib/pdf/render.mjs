...
/**
 * Header default — minimalista, espaço pro título do doc + nome da marca
 * via class="title" (Puppeteer não preenche automático; quem chama põe
 * customizado via options.headerTemplate ou usa este padrão neutro).
 */
...
function defaultFooter() {
  return `
    ...
    ">
      ...
      <span>/ <span class="totalPages"></span></span>
    </div>`;
}
